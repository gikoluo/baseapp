...
export const zh: LangType = {
    ...
    'page.body.wallets.estimated_value': '预估价格',
    ...
    'page.body.wallets.tabs.deposit.fiat.message2': '请将资金转入以下账户，资金将在两个工作日内到账.',
    ...
    'page.body.wallets.tabs.deposit.fiat.referenceCode': '推荐码',
